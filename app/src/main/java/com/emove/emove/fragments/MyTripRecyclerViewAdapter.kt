...
import com.emove.emove.fragments.TripFragment.OnListFragmentInteractionListener
...
class MyTripRecyclerViewAdapter(
        private val mValues: List<SearchResult>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mIdView.text = item.user.name
        holder.mContentView.text = item.user.phone
